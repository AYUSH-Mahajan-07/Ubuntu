class Practical9{
  ...
  public static void main(String[] args){
    ...
    for(int i=0; i<array.length; i++){
      ...
      value = fatorial1(array2[i]); //function call for factorial for
      end = System.nanoTime();
      factorial1time = factorial1time + end - start;
      
      start = System.nanoTime();
      value = fatorial2(array2[i]); //function call for factorial recursive
      end = System.nanoTime();
      factorial2time =factorial2time + end - start;
   }
   
   //here we compare both factorial (for and recursion)
   System.out.println("Timing for factorial (for) : " + factorial1time/array2.length);
